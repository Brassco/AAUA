          ...
          <CardItem>
            <View style={styles.textContainer}>
              <Text style={textStyle}>
                Річна Підписка є пакетом опцій та послуг від асоціації, який
                допомагає економити під-час експлуатації автомобіля та надає
                цілодобовий захист в дорозі по всій території України.
              </Text>
            </View>
          </CardItem>
          <CardItem>
            <View style={styles.textTitleConteinerStyle}>
              <Text style={styles.textTitleStyle}>Технічна допомога</Text>
            </View>
          </CardItem>
          <CardItem>
            <View style={styles.textContainer}>
...
`}
          ...
          <CardItem>
            <View style={styles.textTitleConteinerStyle}>
              <Text style={styles.textTitleStyle}>Доставка палива</Text>
            </View>
          </CardItem>
          <CardItem>
            <View style={styles.textContainer}>
...
`}
          ...
          <CardItem>
            <View style={styles.textTitleConteinerStyle}>
              <Text style={styles.textTitleStyle}>Юридична допомога</Text>
            </View>
          </CardItem>
...
`}
          ...
          <CardItem style={{flexDirection: 'column'}}>
            <View style={styles.textContainer}>
              <Text style={styles.textTitleStyle}>Примітки:</Text>
            </View>
            <View style={styles.textContainer}>
              <Text style={textStyle}>
                {`
...
`}
          ...
          <CardItem>
            <View style={styles.textTitleConteinerStyle}>
              <Text style={styles.textTitleStyle}>Організаційні послуги</Text>
            </View>
          </CardItem>
          <CardItem
            style={{
            ...
            <View style={styles.textContainer}>
              <Text style={[textStyle, {fontSize: 18}]}>
                Клієнт самостійно сплачує вартість послуг, організованих
                Компанією на його прохання:
              </Text>
            </View>
            <View style={styles.textContainer}>
              <Text style={textStyle}>
