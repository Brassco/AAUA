export default {
  ...
  fuel_screen: {
    ...
    qr_code: {
      ...
      message:
        'Якшо у вас не працює QR-код чи винкли труднощі з реєстрацієй, залиште заявку і менеджер Вам допоможе.',
      this_is_your_card_text:
        'Це Ваша віртуальна карта. Для активації віртуальної карти і встановлення пін-кода безпеки необхідно зареєструвати карту на сайті',
